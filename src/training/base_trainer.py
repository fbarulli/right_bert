...
from src.common.managers import get_storage_manager
...
class BaseTrainer:
    ...
    def compute_metrics(
        ...
        """
        Compute metrics (use metrics_manager).

        Args:
            outputs (Union[Dict[str, torch.Tensor], transformers.modeling_outputs.ModelOutput]): Model outputs.
            batch (Dict[str, torch.Tensor]): Input batch.
